...
| **Docyrus Data Grid Pages** | Build Docyrus web data-grid and list pages with `DataGrid`, `DataGridViewSelect`, `useDataGrid`, `useDocyrusDataViewSelect`, and `useDocyrusDataGrid`. | [SKILL.md](./skills/docyrus-data-grid-pages/SKILL.md) |
