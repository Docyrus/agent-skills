...
For *designing* the things these commands manage, use the dedicated skills: **docyrus-data-source-design**, **docyrus-automation-design**, **docyrus-agent-design**, **docyrus-app-ai-tools**, **docyrus-email-template-design**, **docyrus-print-pdf-template-design**, **docyrus-webform-design**, **docyrus-acl-design** (`docyrus acl`), **docyrus-dsql-query-design**. For platform architecture/concepts: **docyrus-platform**. For the REST API in app code: **docyrus-api-dev**.
